...
const ObservationTracker = preload("res://OperatorShell/runtime/ObservationTracker.gd")
const ResultRenderer = preload("res://OperatorShell/runtime/ResultRenderer.gd")
const CommandActions = preload("res://OperatorShell/runtime/CommandActions.gd")
const StatusService = preload("res://OperatorShell/runtime/StatusService.gd")
const OperatorAuditController = preload("res://OperatorShell/audit/OperatorAuditController.gd")
const RightRail = preload("res://OperatorShell/layout/RightRail.gd")
const BottomDock = preload("res://OperatorShell/layout/BottomDock.gd")
const WorkspaceSurface = preload("res://OperatorShell/layout/WorkspaceSurface.gd")
const LeftPanel = preload("res://OperatorShell/layout/LeftPanel.gd")
const TopBars = preload("res://OperatorShell/layout/TopBars.gd")
const DashboardConfig = preload("res://OperatorShell/resources/DashboardConfig.gd")
const QPSConfig = preload("res://OperatorShell/runtime/QPSConfig.gd")
...
func _ready() -> void:
	...
	config = load("res://OperatorShell/resources/dashboard_config.tres")
