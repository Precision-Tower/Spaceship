...
from Engineering.py.cipher.libs.indexed_lookup import (
...
def main() -> None:
    with tempfile.TemporaryDirectory() as tmp:
        ...
        write(
            root / "qps/libs/Python/_index.qps",
            '''
Python.
...
''',
        ...
        write(
            root / "qps/libs/Python/OCC/_index.qps",
            '''
OCC.
...
''',
        ...
        write(
            root / "qps/libs/Python/OCC/Core/_index.qps",
            '''
Core.
...
''',
        ...
        write(
            root
            / "qps/libs/Python/OCC/Core/BRepPrimAPI/_index.qps",
            '''
BRepPrimAPI.
...
''',
        ...
        write(
            root
            / "qps/libs/Python/OCC/Core/BRepPrimAPI"
